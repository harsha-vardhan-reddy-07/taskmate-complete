<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $updateQuery = "UPDATE `crud` SET `Name`='$name',`Dept`='$dept',`Task`='$task' WHERE id = '$id'";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php" style="font-weight: bolder; color: aqua; font-size:1.5rem;">Taskmate</a>
        </div>
    </nav>
    ...
    <?php
        ...
        $que = "SELECT * FROM `crud` WHERE id = '$id'";
